...
if config.dataset == 'U1652-D2S':
    # config.query_folder_train = './Sample4Geo/data/SUES-200-512x512/Training/300/satellite'
    # config.gallery_folder_train = './Sample4Geo/data/SUES-200-512x512/Training/300/drone'   
    # config.query_folder_test = './Sample4Geo/data/SUES-200-512x512/Testing/300/query_drone' 
    # config.gallery_folder_test = './Sample4Geo/data/SUES-200-512x512/Testing/300/gallery_satellite'  
    config.query_folder_train = './Sample4Geo/data/U1652/train/satellite'
    config.gallery_folder_train = './Sample4Geo/data/U1652/train/drone'   
    config.query_folder_test = './Sample4Geo/data/U1652/test/query_drone' 
    config.gallery_folder_test = './Sample4Geo/data/U1652/test/gallery_satellite'      

...
class Configuration:
    ...
    # Learning Rate
    lr: float = 0.000001                    # 1 * 10^-4 for ViT | 1 * 10^-1 for CNN
...
if config.dataset == 'U1652-D2S':
    # config.query_folder_train = '/public/home/houkaiji/dataset/SUES-200/SUES-200-512x512/Training/300/satellite'
    # config.gallery_folder_train = '/public/home/houkaiji/dataset/SUES-200/SUES-200-512x512/Training/300/drone'   
    # # config.query_folder_test = '/public/home/chuyanhao/Sample4Geo/data/test/query_drone' 
    # config.query_folder_test = '/public/home/houkaiji/dataset/SUES-200/SUES-200-512x512/Testing/300/query_drone' 
    # config.gallery_folder_test = '/public/home/houkaiji/dataset/SUES-200/SUES-200-512x512/Testing/300/gallery_satellite' 
    # 
...
if __name__ == '__main__':
    ...
    model_path = "{}/{}/{}/{}".format(config.model_path,"hkjViT",
                                       config.model,
                                       time.strftime("%H%M%S"))

...
if config.dataset == 'U1652-D2S':
    config.query_folder_train = r'/public/home/houkaiji/dataset/SUES-200/SUES-200-512x512/Training/300/satellite'
    config.gallery_folder_train = r'/public/home/houkaiji/dataset/SUES-200/SUES-200-512x512/Training/300/drone'   
...
if __name__ == '__main__':
    ...
    model_path = "{}/{}/{}/{}".format(config.model_path,"hkj150",
                                       config.model,
                                       time.strftime("%H%M%S"))
